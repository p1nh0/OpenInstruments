...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 160.0, 84.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.0, 135.0, 122.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 591.75, 6.0, 150.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.75, 1.0, 473.0, 28.0 ],
					"presentation_rect" : [ 671.0, 7.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.0, 169.0, 180.0, 55.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 11.0, 180.0, 55.0 ],
					"varname" : "api_input"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 284.0, 83.0, 204.0, 22.0 ],
					"text" : "(optional only if you need an audio input"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 245.0, 81.0, 18.0 ],
					"text" : "send~ oi.api.in2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 245.0, 81.0, 18.0 ],
					"text" : "send~ oi.api.in1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 184.0, 83.0, 100.0, 18.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -485.0, 135.0, 125.0, 22.0 ],
					"text" : "Layer system"
				}
...
, 			{
				"box" : 				{
					...
					"interp" : 					{
						...
						"oi.stereotrack~::pan::pan" : [ 0, 16386560.0 ],
						"oi.stereotrack~::pan::ramp" : [ 0, 16386560.0 ],
						"oi.stereotrack~::gain" : [ 0, 0.0 ],
						"oi.stereotrack~::bypass" : [ 0, 0.0 ],
						"oi.stereotrack~::state" : [ 0, 0.0 ],
						"oi.stereotrack~::module_name" : [ 0, 0.0 ],
						"oi.stereotrack~::ramp" : [ 0, 0.0 ],
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -370.0, 300.0, 132.75, 69.0 ],
					"priority" : 					{
						"oi.stereotrack~::pan::pan" : -5,
						"oi.stereotrack~::pan::ramp" : -6,
						"oi.stereotrack~::gain" : -5,
						"oi.stereotrack~::bypass" : -6,
						"oi.stereotrack~::state" : -5,
						"oi.stereotrack~::module_name" : -10,
						"oi.stereotrack~::ramp" : -6,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -160.0, 300.0, 80.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 354.5, 234.0, 274.5, 234.0 ],
					"source" : [ "obj-19", 1 ]
				}
