...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 432.0, 409.0, 246.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 395.0, 350.0, 29.0 ],
					"text" : "oi.modulecom #0 \"your module's name to appear in the print window\" @patcher +"
				}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 151.0, 255.0, 150.0 ],
									"rounded" : 6
								}
