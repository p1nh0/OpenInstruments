...
, 			{
				"box" : 				{
					"active" : 					{
						"instrument_name" : 0,
						"instrument_state" : 0,
						"SNDPROCESSOR::oi.idv.key::OUTPUT" : 0,
...
,
					...
					"interp" : 					{
						...
						"SNDPROCESSOR::oi.idv.key::module_name" : [ 0, 0.0 ],
						"SNDPROCESSOR::oi.idv.key::keycode" : [ 0, 0.0 ],
						"SNDPROCESSOR::oi.idv.key::mode" : [ 0, 0.0 ],
						"SNDPROCESSOR::oi.idv.key::bypass" : [ 0, 0.0 ],
						"SNDPROCESSOR::oi.idv.key::state" : [ 0, 0.0 ],
						"SNDPROCESSOR::oi.vst~[1]::plugin" : [ 0, 0.0 ],
						"SNDPROCESSOR::oi.vst~[1]::module_name" : [ 0, 0.0 ],
						"SNDPROCESSOR::oi.vst~[1]::bypass" : [ 0, 0.0 ],
						"SNDPROCESSOR::oi.vst~[1]::state" : [ 0, 0.0 ],
...
,
					...
					"priority" : 					{
						...
						"SNDPROCESSOR::oi.idv.key::module_name" : -10,
						"SNDPROCESSOR::oi.idv.key::keycode" : -8,
						"SNDPROCESSOR::oi.idv.key::mode" : -7,
						"SNDPROCESSOR::oi.idv.key::register" : -6,
						"SNDPROCESSOR::oi.idv.key::velocity" : -6,
						"SNDPROCESSOR::oi.idv.key::bypass" : -6,
						"SNDPROCESSOR::oi.idv.key::state" : -5,
						"SNDPROCESSOR::oi.vst~[1]::plugin" : -10,
						"SNDPROCESSOR::oi.vst~[1]::module_name" : -10,
						"SNDPROCESSOR::oi.vst~[1]::bypass" : -6,
						"SNDPROCESSOR::oi.vst~[1]::params" : -5,
						"SNDPROCESSOR::oi.vst~[1]::out" : -5,
						"SNDPROCESSOR::oi.vst~[1]::in" : -5,
						"SNDPROCESSOR::oi.vst~[1]::state" : -5,
...
, 			{
				"box" : 				{
					...
					"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 42, 48, 291, 452, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 440.0, 380.0, 20.0, 20.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 538.0, 311.0, 170.0, 100.0 ],
									"varname" : "oi.vst~[1]"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 630.0, 80.0, 50.0, 18.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 630.0, 150.0, 50.0, 18.0 ],
									"presentation_rect" : [ 630.0, 154.0, 0.0, 0.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 630.0, 120.0, 50.0, 18.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 560.0, 240.0, 32.5, 18.0 ],
									"text" : "pack"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 560.0, 210.0, 82.0, 18.0 ],
									"text" : "makenote 100 5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 560.0, 188.0, 32.5, 18.0 ],
									"text" : "+ 36",
									"varname" : "u834010564"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 560.0, 150.0, 58.0, 18.0 ],
									"text" : "random 11"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 560.0, 120.0, 56.0, 18.0 ],
									"text" : "metro 200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 388.0, 108.0, 125.0, 60.0 ],
									"varname" : "oi.idv.key"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 380.666656, 360.0, 50.0, 50.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "signal", "signal", "int", "" ],
									"patching_rect" : [ 280.0, 230.0, 170.0, 100.0 ],
									"varname" : "oi.vst~"
								}
