...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 41.0, 33.0, 12.0 ],
					"text" : "hide $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 20.0, 17.0, 49.0, 18.0 ],
					"text" : "oi.gate~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 65.0, 138.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					"attr" : "fgcolor",
					"attrfilter" : [ "buffsize", "calcount", "range", "fgcolor" ],
					"fontname" : "Arial",
					"fontsize" : 10.0,
					"id" : "obj-9",
					"maxclass" : "attrui",
					...
					"orientation" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 17.0, 75.0, 36.0 ],
