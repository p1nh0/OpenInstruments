...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 0.0, 154.0, 60.0 ],
					"varname" : "oi.idv.hi"
				}
...
, 			{
				"name" : "oi.gate.maxpat",
				"bootpath" : "/Applications/Max6/patches/Open Instruments_dev_0.3/API/API system",
				"patcherrelativepath" : "../../../Open Instruments_dev_0.3/API/API system",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
