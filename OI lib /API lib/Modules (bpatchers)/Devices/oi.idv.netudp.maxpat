...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 242.0, 62.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 27.0, 28.0, 18.0 ],
					"text" : "port"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 350.0, 17.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 78.049042, 3.0, 20.0, 20.0 ],
					"rounded" : 32.0,
					"text" : "p",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 96.049042, 3.0, 20.0, 20.0 ],
					"rounded" : 32.0,
					"text" : "+",
					"textcolor" : [ 0.079882, 0.076941, 0.075878, 1.0 ],
					"texton" : "+",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 186.0, 596.5, 39.0, 18.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 729.5, 225.0, 29.0 ],
					"text" : "binds to oi.api so that we can access all network ports in one single oi.hub"
				}

			}
, 			{
				"box" : 				{
					"comment" : "(anything) Input messages from udpreceive",
					"id" : "obj-13",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.0, 739.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.0, 654.5, 42.0, 16.0 ],
					"text" : "port $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 186.0, 674.5, 39.0, 18.0 ],
					"text" : "zl.join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 186.0, 624.5, 258.0, 18.0 ],
					"restore" : [ 7474 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr @bindto port @autorestore 0 @invisible 1 @thru 0",
					"varname" : "u063000482"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 186.0, 699.5, 334.0, 18.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 23.5, 450.5, 103.0, 41.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 186.0, 566.5, 32.5, 18.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 126.0, 789.5, 50.0, 14.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 50.0, 120.0, 14.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 126.0, 753.5, 52.0, 18.0 ],
					"text" : "oi.vfgate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 130.0, 566.5, 52.0, 18.0 ],
					"text" : "oi.vfgate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.0, 596.5, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 31.0, 10.0, 10.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 200.0, 240.0, 107.0, 52.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"initial" : [ 7474 ]
					}
,
					"text" : "pattr @name port @default_interp off @initial 7474 @default_priority -5",
					"varname" : "port"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 218.5, 359.5, 103.5, 64.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"initial" : [ 2048 ]
					}
,
					"text" : "pattr @name maxqueuesize @default_interp off @initial 2048 @default_priority -5",
					"varname" : "maxqueuesize"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "listen to port #",
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 244.0, 298.5, 49.5, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 30.049042, 27.0, 68.5, 18.0 ],
					"triangle" : 0,
					"varname" : "number"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.0, 434.5, 46.0, 16.0 ],
					"text" : "quiet $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 325.0, 389.5, 190.0, 18.0 ],
					"restore" : [ 1 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr @bindto ::oi.api::mode @invisible 1",
					"varname" : "u611000539"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 486.5, 84.0, 23.0 ],
					"text" : "udpreceive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 325.5, 50.0, 16.0 ],
					"text" : "port $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 218.5, 434.5, 88.0, 16.0 ],
					"text" : "maxqueuesize $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 206.0, 159.0, 18.0 ],
					"text" : "oi.modulecom #0 oi.idv.netudp "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 175.5, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 40.0, 127.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 17.0, 127.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 636.0, 42.0, 52.0, 18.0 ],
					"text" : "s #0-print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 44.0, 51.0, 18.0 ],
					"text" : "r #0-print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 135.0, 52.0, 18.0 ],
					"text" : "pvar print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 110.0, 38.0, 16.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 514.0, 85.0, 199.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 135.0, 71.0, 18.0 ],
					"text" : "options patch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 739.0, 60.0, 57.0, 18.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "close" ],
					"patching_rect" : [ 777.0, 85.0, 39.0, 18.0 ],
					"text" : "t close"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 739.0, 110.0, 46.0, 18.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "open" ],
					"patching_rect" : [ 739.0, 85.0, 38.0, 18.0 ],
					"text" : "t open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 739.0, 35.0, 65.0, 18.0 ],
					"text" : "pvar options"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 240.0, 60.0, 150.0, 17.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 36.0, 18.0, 73.0, 17.0 ],
									"text" : "max queue size"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 210.0, 60.0, 30.0, 17.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 6.0, 18.0, 30.0, 17.0 ],
									"triangle" : 0
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 210.0, 95.0, 229.0, 18.0 ],
									"restore" : [ 2048 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
,
									"text" : "pattr @bindto parent::maxqueuesize @invisible 1",
									"varname" : "u091000435"
								}
...
, 							{
								"box" : 								{
									...
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "float", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 261, 371, 376, 412, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 182.0, 20.0, 263.0, 135.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 115.0, 40.0 ],
									"rounded" : 6
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 219.5, 145.0, 192.5, 145.0, 192.5, 50.0, 219.5, 50.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
,
					"patching_rect" : [ 739.0, 135.0, 56.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"tags" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 586.0, 44.0, 127.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 492.0, 9.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 3.0, 117.0, 22.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 497.0, 224.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 120.0, 50.0 ],
					"rounded" : 6
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 523.5, 162.0, 720.5, 162.0, 720.5, 75.0, 703.5, 75.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 33.0, 528.5, 195.5, 528.5 ],
					"source" : [ "obj-30", 0 ]
				}
