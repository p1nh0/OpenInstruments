...
,
					"patching_rect" : [ 807.75, 993.0, 35.0, 16.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 127.5, 52.0, 18.0 ],
									"text" : "s #0-print"
								}
...
,
					"patching_rect" : [ 611.125, 420.0, 33.0, 16.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"description" : "",
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 249.0, 825.0, 145.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.049042, 49.0, 70.0, 65.0 ],
					"setminmax" : [ 0.0, 0.0 ],
					"slidercolor" : [ 0.635294, 0.964706, 0.482353, 0.5 ],
					"thickness" : 6
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 341.5, 531.75, 135.0, 29.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr @bindto input_max @invisible 1 @autorestore 0",
					"varname" : "u902000059"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 290.0, 497.0, 139.0, 29.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr @bindto input_min @invisible 1 @autorestore 0",
					"varname" : "u855000057"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 14.0, 490.5, 140.0, 29.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "pattr @bindto ramp_slope @invisible 1 @autorestore 0",
					"varname" : "u181001332"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 812.0, 34.5, 18.0 ],
					"text" : "pack"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 135.049042, 96.0, 50.0, 18.0 ],
					"triangle" : 0,
					"varname" : "flonum[5]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1334.0, 563.75, 132.0, 41.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.049042, 96.0, 50.0, 18.0 ],
					"triangle" : 0,
					"varname" : "flonum[4]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1097.5, 563.75, 129.0, 41.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 914.0, 747.0, 155.0, 41.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 20 ],
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1103.5, 357.0, 58.5, 30.0 ],
					"text" : "input\nmaximum"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1074.5, 479.0, 132.0, 52.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 0.0 ],
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 898.5, 870.5, 195.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.049042, 72.0, 50.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1059.5, 391.0, 126.0, 41.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 898.5, 808.5, 180.5, 23.0 ],
					"text" : "o.ramp 0."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 135.049042, 72.0, 50.0, 18.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"triangle" : 0,
					"varname" : "flonum[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 898.5, 935.0, 195.0, 23.0 ],
					"text" : "scale 0. 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 994.75, 312.5, 129.25, 41.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 772.25, 312.5, 123.0, 41.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 680.0, 235.5, 115.0, 41.0 ],
					"restore" : [ "clip" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 898.5, 702.0, 115.25, 23.0 ],
					"text" : "o.wrap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 723.5, 702.0, 115.25, 23.0 ],
					"text" : "o.fold"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 563.5, 702.0, 107.25, 23.0 ],
					"text" : "clip"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 573.5, 148.5, 18.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 56.5, 768.5, 37.0, 18.0 ],
					"text" : "* 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 56.5, 697.0, 36.0, 18.0 ],
					"text" : "/ 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 41.0, 653.5, 34.5, 18.0 ],
					"text" : "t i i"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 623.5, 46.0, 18.0 ],
					"text" : "uzi 127"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.5, 733.5, 106.0, 18.0 ],
					"text" : "expr $f1*pow($f1\\,$f2)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 817.5, 870.5, 81.0, 18.0 ],
					"text" : "y = x*(x^slope)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 580.0, 52.0, 16.0 ],
					"text" : "setmin $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.5, 580.0, 56.0, 16.0 ],
					"text" : "setmax $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 41.0, 843.5, 98.0, 65.0 ],
					"pointcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 60.049042, 49.0, 70.0, 64.0 ],
					"range" : 127,
					"size" : 127
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 641.0, 206.0, 215.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.049042, 49.0, 180.0, 65.0 ],
					"rounded" : 6
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1107.0, 909.75, 1013.599976, 909.75 ],
					"source" : [ "obj-156", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1343.5, 923.25, 1048.800049, 923.25 ],
					"source" : [ "obj-159", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 174.5, 834.625, 50.5, 834.625 ],
					"source" : [ "obj-174", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 594.0, 477.875, 258.5, 477.875 ],
					"source" : [ "obj-40", 1 ]
				}
