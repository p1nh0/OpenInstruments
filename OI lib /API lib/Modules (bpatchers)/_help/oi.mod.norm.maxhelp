...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 20.0, 90.0, 236.0, 21.0 ],
									"prototypename" : "oi.help_digest",
									"text" : "—> add 'flip' button to invert the output "
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"jsarguments" : [ "oi.mod.norm" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 365.0, 50.0 ]
								}
...
,
					"patching_rect" : [ 12.0, 112.0, 58.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 175.0, 147.0, 18.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "js helpstarter oi.mod.norm"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 272.0, 246.0, 260.0, 19.0 ],
									"text" : "1. 0.625 -0.208333 0.666667"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 172.0, 167.0, 260.0, 50.0 ],
									"size" : 4
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 62.0, 196.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 112.0, 196.0, 50.0, 21.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 112.0, 246.0, 143.0, 115.0 ],
									"varname" : "oi.mod.norm"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 89.0, 402.0, 21.0 ],
									"prototypename" : "oi.help_digest",
									"text" : "Simple tool for the normalization of input streams (int, floats or lists).",
