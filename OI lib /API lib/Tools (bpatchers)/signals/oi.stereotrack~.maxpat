...
,
					"patching_rect" : [ 25.5, 280.0, 49.0, 18.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 10.0,
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 158.5, 330.0, 60.0, 18.0 ],
					"text" : "o.bypass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 232.0, 295.0, 47.0, 16.0 ],
					"text" : "ramp $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 68.5, 330.0, 60.0, 18.0 ],
					"text" : "o.bypass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 290.0, 305.0, 345.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 25.0 ],
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.5, 565.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 199.5, 565.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 199.5, 280.0, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 109.5, 280.0, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 110.0, 410.0, 22.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 27.0, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 310.0, 359.0, 333.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 0 ],
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 109.5, 359.0, 109.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 147.0, 23.0, 28.433702, 28.433702 ],
					"varname" : "pan"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 200.0, 410.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 170.0, 410.0, 22.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 37.0, 142.0, 12.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 140.0, 410.0, 22.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 27.0, 142.0, 12.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 820.0, 145.0, 236.0, 18.0 ],
					"text" : "oi.modulecom #0 oi.stereotrack~ @patcher pan"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 820.0, 114.5, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 654.0, 45.0, 65.0, 18.0 ],
					"text" : "pvar options"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 199.0, 220.0, 38.0, 16.0 ],
									"presentation_rect" : [ 199.0, 217.5, 0.0, 0.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 245.0, 165.0, 160.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 51.0, 38.0, 97.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 199.0, 165.0, 46.0, 16.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 5.0, 38.0, 46.0, 16.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 199.0, 195.0, 281.0, 18.0 ],
									"restore" : [ 50.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 182.0, 23.5, 56.0, 18.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 199.0, 115.5, 38.0, 16.0 ],
									"text" : "set $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 245.0, 60.5, 160.0, 18.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 51.0, 19.0, 113.0, 18.0 ],
									"text" : "volume ramp time (ms)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 199.0, 60.5, 46.0, 16.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 5.0, 20.0, 46.0, 16.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 199.0, 90.5, 259.0, 18.0 ],
									"restore" : [ 25.0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "float", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 1048, 307, 1213, 368, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 164.0, 60.0 ],
									"rounded" : 6
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 208.5, 249.0, 191.0, 249.0, 191.0, 154.0, 208.5, 154.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 208.5, 144.5, 191.0, 144.5, 191.0, 49.5, 208.5, 49.5 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 654.0, 145.0, 56.0, 23.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 10.0,
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 45.049042, 3.0, 98.0, 20.0 ],
					"rounded" : 0.0,
					"text" : "oi.stereotrack2~",
					"varname" : "textedit"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 156.049042, 3.0, 20.0, 20.0 ],
					"rounded" : 32.0,
					"text" : "+",
					"textcolor" : [ 0.079882, 0.076941, 0.075878, 1.0 ],
					"texton" : "+",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 180.0, 55.0 ],
					"rounded" : 6
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 476.5, 403.0, 119.0, 403.0 ],
					"source" : [ "obj-109", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 299.5, 332.0, 282.0, 332.0, 282.0, 285.0, 241.5, 285.0 ],
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 299.5, 380.0, 213.0, 380.0 ],
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 299.5, 374.0, 123.0, 374.0 ],
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 78.0, 552.5, 119.0, 552.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 78.0, 402.5, 149.5, 402.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 241.5, 314.0, 78.0, 314.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 241.5, 320.0, 168.0, 320.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 168.0, 559.5, 209.0, 559.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 168.0, 394.5, 179.5, 394.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 35.0, 322.5, 78.0, 322.5 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 35.0, 306.5, 168.0, 306.5 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				...
				"patcherrelativepath" : "../../../Utilities (objects)/Signals",
				"type" : "JSON",
				"implicit" : 1
			}
 ]
