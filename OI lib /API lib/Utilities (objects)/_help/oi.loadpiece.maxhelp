...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 67.0, 124.0, 18.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "js helpstarter oi.loadpiece"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 300.0, 200.0, 154.0, 55.0 ],
									"text" : "select a piece from those available in the concert project folder "
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 0,
									"numoutlets" : 0,
									"patching_rect" : [ 75.0, 200.0, 225.0, 43.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 89.0, 309.0, 21.0 ],
									"prototypename" : "oi.help_digest",
									"text" : "User interface to insert a 'Piece' inside a 'Concert'.",
...
,
					"patching_rect" : [ 20.0, 120.0, 50.0, 18.0 ],
					"saved_object_attributes" : 					{
						"fontname" : "Arial",
						"default_fontsize" : 10.0,
						"description" : "",
