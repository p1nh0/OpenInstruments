...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 100.0, 58.0, 39.0 ],
													"text" : "oi.module_template_a0.5"
												}
...
,
					"patching_rect" : [ 15.0, 130.0, 83.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"digest" : "",
						"default_fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 10.0, 139.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 45.0, 84.0, 18.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 110.25, 130.0, 103.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 53.049042, 18.0, 132.0, 20.0 ],
					"rounded" : 0.0,
					"text" : "oi.module_template_a0.5",
					"varname" : "textedit"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 24.5, 117.0, 3.0, 117.0, 3.0, 32.0, 24.5, 32.0 ],
					"source" : [ "obj-35", 0 ]
				}
