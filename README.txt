...
I'm currently fixing some bugs, improving documentation (for the plane user first, and then for interested developers), making examples and uploading videos to this project's youtube channel, found here http://www.youtube.com/user/pi1nh0c0d1ng. So please be patient. 
...
5 — MOVE "OI_LIB" somewhere where Max can see it 
		...
		option b)  move it to wherever you want, then go to "Max > Options menu > File Preferences" 
			and add "OI lib" path (don't forget to check subfolders)
			(you can leave "OI examples" outside max's search path‚if you want to…)

6 - Read 'dependencies.txt' to know what externals you'll need to install. 


NOTES: 

Tested on MaxMSP 6.0.5. and 6.0.7. No guaranties for previous versions… 
