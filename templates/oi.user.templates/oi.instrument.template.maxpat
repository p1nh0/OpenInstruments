...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ -579.0, 152.0, 63.0, 18.0 ],
					"text" : "t getname s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -579.0, 177.0, 48.0, 18.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ -579.0, 130.5, 89.0, 18.0 ],
					"text" : "o.symbolchange"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ -595.0, 110.0, 65.0, 18.0 ],
					"text" : "sel <empty>"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 195.620483, 18.774525, 50.0, 16.725475 ],
					"rounded" : 8.0,
					"text" : "p",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -307.5, 140.0, 68.5, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 195.620483, 4.0, 50.0, 17.0 ],
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ],
					"varname" : "spaces"
				}
...
,
					"patching_rect" : [ -596.75, 245.0, 111.5, 40.0 ],
...
,
					"patching_rect" : [ -596.75, 210.0, 209.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"oncolor" : [ 0.673018, 1.0, 0.106775, 1.0 ],
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3.75, 3.0, 58.0, 58.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.5, 2.0, 35.5, 35.5 ],
					"varname" : "active"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 34.810242, 120.0, 180.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ -595.0, 80.0, 548.0, 29.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "<empty>" ],
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 157, 263, 417, 718, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 3.0, 215.0, 58.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.5, 45.0, 251.689758, 70.0 ],
					"varname" : "PRESETS"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -606.0, 0.0, 610.75, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.5, 0.0, 250.0, 40.0 ],
					"rounded" : 6
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ -436.5, 422.0, -340.25, 422.0, -340.25, 675.0, -272.666667, 675.0 ],
					"source" : [ "obj-186", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ -569.5, 203.0, -602.5, 203.0, -602.5, 51.0, -585.5, 51.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ -265.5, 498.5, -208.583333, 498.5 ],
					"source" : [ "obj-271", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ -204.5, 614.5, -208.583333, 614.5 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ -525.5, 207.0, -607.0, 207.0, -607.0, 52.0, -585.5, 52.0 ],
					"source" : [ "obj-40", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ -92.833339, 508.5, -65.5, 508.5 ],
					"source" : [ "obj-58", 1 ]
				}
