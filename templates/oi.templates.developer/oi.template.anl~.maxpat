...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.25, 620.0, 156.0, 37.0 ],
					"presentation_rect" : [ 91.0, 624.0, 0.0, 0.0 ],
					"text" : "add/delete channels according to your needs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 71.832375, 334.332367, 100.0, 20.0 ],
					"presentation_rect" : [ 85.664742, 318.332367, 0.0, 0.0 ],
					"text" : "right channel "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.167629, 333.0, 20.66474, 20.66474 ],
					"presentation_rect" : [ 65.0, 327.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.667629, 625.0, 20.66474, 20.66474 ],
					"presentation_rect" : [ 60.0, 625.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.5, 510.0, 87.0, 18.0 ],
					"presentation_rect" : [ 50.0, 508.0, 0.0, 0.0 ],
					"text" : "oi.module.gate~",
					"varname" : "inputrate[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 17.0, 475.0, 87.0, 18.0 ],
					"text" : "oi.module.gate~",
					"varname" : "inputrate[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 290.0, 156.0, 37.0 ],
					"text" : "add/delete channels according to your needs"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 70.0, 445.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 145.0, 475.0, 144.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 625.0, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.664742, 284.332367, 89.0, 20.0 ],
					"text" : "left channel"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 26.5, 611.0, 26.5, 611.0 ],
					"source" : [ "obj-40", 0 ]
				}
