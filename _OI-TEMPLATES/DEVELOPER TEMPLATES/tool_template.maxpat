...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 17.0, 475.0, 78.0, 18.0 ],
					"text" : "oi.modulegate",
					"varname" : "inputrate[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 328.0, 156.0, 24.0 ],
					"text" : "input via pattr as well"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 17.25, 330.0, 268.0, 18.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.0, 672.0, 156.0, 24.0 ],
					"text" : "output via pattr as well"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 76.0, 675.0, 279.0, 18.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 360.0, 135.0, 150.0, 22.0 ],
									"text" : "accessing named objects"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 92.0, 135.0, 268.0, 18.0 ],
									"restore" : [ 0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
,
					"patching_rect" : [ 76.0, 535.0, 144.0, 23.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"fontname" : "Arial",
						"default_fontsize" : 10.0,
...
,
					"text" : "p \"your main patch\"",
					"varname" : "your main patch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.0, 640.0, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 240.0, 453.0, 44.0 ],
					"text" : "your patch "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 432.25, 405.0, 246.0, 22.0 ],
					"text" : "add your subpatchers for outside communication "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 765.0, 185.0, 352.0, 39.0 ],
					"text" : "module's print function + options subpatcher "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 259.0, 364.5, 107.0, 93.0 ],
					"text" : "speedlim controlled via oi.api (optional for stream processing modules)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 725.0, 395.0, 123.0, 38.0 ],
					"text" : "communication to all pattr objects"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 286.332367, 156.0, 38.0 ],
					"text" : "left inlet (optional) — input processing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 396.0, 350.5, 29.0 ],
					"text" : "oi.modulecom \"#0-your module's name to appear in the print window\" @patcher + oi-speedlim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 405.0, 248.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.25, 295.0, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 364.5, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 364.5, 156.0, 24.0 ],
					"text" : "rightmost inlet (optional)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 635.0, 0.0, 249.0, 31.0 ],
					"text" : "module's graphical interface"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 214.0, 17.0, 108.0, 64.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 887.0, 44.0, 52.0, 18.0 ],
					"text" : "s #0-print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 765.0, 87.0, 199.0, 18.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 96.0, 145.0, 18.0 ],
									"text" : "OTHER OPTIONS"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 96.0, 255.0, 150.0 ],
									"rounded" : 6
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 182.0, 205.0, 71.75, 41.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 252.75, 235.0, 63.0, 16.0 ],
									"text" : "in0 defer $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 182.0, 155.0, 160.5, 41.0 ],
									"restore" : [ 0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 432.0, 155.0, 378.0, 18.0 ],
									"saved_object_attributes" : 									{
										"initial" : [ "internal" ],
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 365.0, 410.0, 211.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "grow", "close", "zoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 261, 371, 516, 617, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
									"text" : "thispatcher"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 837.0, 46.0, 127.0, 41.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 168.049042, 3.0, 20.0, 20.0 ],
					"rounded" : 32.0,
					"text" : "p",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ],
					"texton" : "p",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 186.049042, 3.0, 20.0, 20.0 ],
					"rounded" : 32.0,
					"text" : "+",
					"textcolor" : [ 0.901961, 0.901961, 0.901961, 1.0 ],
					"texton" : "+",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 3.0, 210.0, 22.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 210.0, 128.0 ],
					"rounded" : 6
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 774.5, 164.0, 971.5, 164.0, 971.5, 77.0, 954.5, 77.0 ],
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 26.5, 633.0, 85.5, 633.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 26.5, 611.0, 358.5, 611.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 85.5, 599.25, 358.5, 599.25 ],
					"source" : [ "obj-75", 0 ]
				}
