...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 205.0, 455.0, 54.0, 18.0 ],
									"text" : "print input"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 545.0, 480.0, 69.0, 18.0 ],
									"text" : "print operand"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 95.0, 33.0, 18.0 ],
									"text" : "defer"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 365.75, 315.0, 32.5, 18.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 365.75, 340.0, 32.5, 18.0 ],
									"text" : "grab"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 625.0, 320.0, 32.5, 18.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 625.0, 345.0, 32.5, 18.0 ],
									"text" : "grab"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 77.0, 24.0, 18.0 ],
									"text" : "iter"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 320.5, 677.0, 210.0, 677.0 ],
									"source" : [ "obj-100", 2 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 720.5, 296.0, 436.0, 296.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 634.5, 407.5, 335.0, 407.5 ],
									"source" : [ "obj-27", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 361.0, 364.5, 405.0, 364.5 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 461.500122, 760.0, 423.0, 18.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "+", 0, "+", 0, "+", 0, "+", 0 ],
						"parameter_enable" : 0
					}
...
,
					"text" : "pattr @name mode @default_interp off @default_priority -6 @type char",
					"varname" : "mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.582342, 532.5, 50.0, 14.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 700.0, 600.0, 63.0, 18.0 ],
									"text" : "prepend set"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 700.0, 624.0, 156.0, 18.0 ],
