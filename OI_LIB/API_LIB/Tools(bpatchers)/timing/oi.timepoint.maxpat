...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 430.0, 32.5, 18.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 416.0, 385.0, 32.5, 18.0 ],
					"text" : "t f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 416.0, 408.0, 32.5, 18.0 ],
					"text" : "> 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.25, 275.0, 118.0, 18.0 ],
					"text" : "loadmess mode position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 400.0, 235.0, 325.0, 18.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"initial" : [ "internal" ]
					}
,
					"text" : "pattr transport @initial internal @type symbol @default_priority -9",
					"varname" : "transport"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.5, 555.0, 32.5, 18.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 256.5, 555.0, 32.5, 18.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 21.0, 450.0, 239.0, 18.0 ],
					"restore" : [ 1 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 416.0, 520.0, 114.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.0, 61.0, 114.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 270.0, 300.0, 114.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.0, 33.0, 114.0, 20.0 ],
					"varname" : "timepoint"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 530.0, 520.0, 63.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 82.0, 50.5, 63.0, 16.0 ],
					"text" : "remaining time"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 183.25, 300.0, 71.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 98.0, 22.0, 47.0, 16.0 ],
					"text" : "time point "
				}
...
, 			{
				"box" : 				{
					"comment" : "(anything) remaining time",
					"id" : "obj-45",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 402.5, 590.0, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.0, 430.0, 38.0, 16.0 ],
					"text" : "out $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 490.0, 74.0, 18.0 ],
					"text" : "prepend value"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 400.0, 260.0, 64.0, 16.0 ],
					"text" : "transport $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 416.0, 367.0, 32.5, 18.0 ],
					"text" : "!- 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 429.0, 465.0, 88.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 450.0, 305.0, 163.0, 18.0 ],
					"text" : "metro @active 1 @interval 5. ticks"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 400.0, 340.0, 35.0, 18.0 ],
					"text" : "when"
				}
...
, 			{
				"box" : 				{
					"comment" : "(bang) bang at designated time ",
					"id" : "obj-12",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.5, 590.0, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 305.0, 437.0, 60.0, 60.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 20.0, 73.0, 73.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 330.0, 32.5, 16.0 ],
					"text" : "in $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 367.0, 163.0, 18.0 ],
					"text" : "translate ms ticks @mode position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 270.0, 408.0, 114.0, 18.0 ],
					"text" : "timepoint @time 0 ticks"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 0.0, 10.0, 117.0, 64.0 ],
					"restore" : [ 1 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
,
					"patching_rect" : [ 140.0, 165.0, 54.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"fontname" : "Arial",
						"tags" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 276.0, 590.0, 127.0, 41.0 ],
					"restore" : [ "0.0.5" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 145.0, 265.0, 18.0 ],
					"text" : "oi.modulecom #0-oi.timepoint  @patcher timepoint"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 585.0, 114.5, 20.66474, 20.66474 ]
				}
...
,
					"patching_rect" : [ 140.0, 140.0, 83.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"fontname" : "Arial",
						"tags" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 20.0, 139.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.0, 55.0, 96.0, 18.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 140.0, 91.0, 209.5, 41.0 ],
					"restore" : [ "oi.timepoint" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 49.0, 84.0, 20.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 235.25, 140.0, 103.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 25.049042, 3.0, 119.950958, 20.0 ],
					"rounded" : 0.0,
					"text" : "oi.timepoint",
					"varname" : "textedit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 0.0, 350.0, 6.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 3.0, 148.0, 22.0 ],
					"rounded" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 30.5, 519.0, 266.0, 519.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 30.5, 504.0, 412.0, 504.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 266.0, 581.0, 285.5, 581.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 412.0, 581.0, 285.5, 581.0 ],
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 149.5, 127.0, 128.0, 127.0, 128.0, 42.0, 149.5, 42.0 ],
					"source" : [ "obj-35", 0 ]
				}
