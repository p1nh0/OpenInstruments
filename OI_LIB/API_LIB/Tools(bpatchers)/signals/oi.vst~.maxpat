...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 134.0, 76.0, 18.0 ],
									"text" : "print #0-oi.vst~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 118.0, 333.0, 16.0 ],
									"text" : "vst~ : messages to vst~ object inside, query : umenu object to query vst~"
								}
...
,
					"patching_rect" : [ 830.0, 235.0, 109.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 635.0, 395.0, 54.0, 18.0 ],
					"text" : "zl.group 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 635.0, 370.0, 100.0, 18.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 670.0, 115.5, 110.0, 51.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1.0 ],
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 550.0, 115.5, 106.0, 51.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1.0 ],
						"parameter_enable" : 0
					}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 200.0, 10.0, 116.0, 51.0 ],
									"restore" : [ "oi.vst~" ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 7.75, 10.0, 87.25, 51.0 ],
									"restore" : [ "open" ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 95.0, 10.0, 87.0, 51.0 ],
									"restore" : [ "<empty>" ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 7.75, 15.0, 85.0, 51.0 ],
									"restore" : [ 0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 95.0, 15.0, 93.0, 51.0 ],
									"restore" : [ 0 ],
									"saved_object_attributes" : 									{
										"parameter_enable" : 0
									}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 635.0, 425.0, 93.0, 18.0 ],
...
, 			{
				"box" : 				{
					"comment" : "midi (list: note velocity)",
					"id" : "obj-24",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 635.0, 337.5, 20.66474, 20.66474 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 155.0, 490.0, 264.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 213.5, 17.0, 110.0, 51.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 25.5, 112.0, 209.5, 40.0 ],
					"restore" : [ "oi.vst~" ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
,
					"patching_rect" : [ 1055.0, 132.0, 56.0, 22.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 10.0,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 644.5, 458.5, 164.5, 458.5 ],
					"source" : [ "obj-38", 0 ]
				}
